...
\renewcommand{\operation}{ \left[ C \right] := \mbox{\sc syrk\_lt\_unb\_var3}( A, C ) }
...
\renewcommand{\beforeupdate}{
	...
	a_1^TA_0 + \widehat c_{10}^T & \widehat \gamma_{11} & \widehat c_{12}^T \\  
	A_2^TA_0 + \widehat C_{20} & \widehat c_{21} & \widehat C_{22}
	\end{array}\right)
	$
}
...
\renewcommand{\afterupdate}{
	...
	A_2^TA_0 + \widehat C_{20} & A_2^Ta_1 + \widehat c_{21} & \widehat C_{22}
	\end{array}\right)
	$}
